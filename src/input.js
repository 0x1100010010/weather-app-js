...
export const input = () => {
  ...
  codefactory('input', { class: 'sr-only', type: 'checkbox', id: 'toggle-status' }, '', 'toggle-button-container').addEventListener('change', api);
  ...
  codefactory('input', {
    class: 'w-full bg-gray-100 rounded border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out', type: 'text', id: 'location-name', name: 'name', placeholder: 'Name', required: '',
  }, '', 'loaction-form');
  api();
};
